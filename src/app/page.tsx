    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center overflow-x-hidden">
            ...
            >
                ...
                <div className="flex z-1 flex-col h-min pt-36 space-y-5 w-auto md:flex-col justify-center items-center">
                    <p className="">Front-end . Software Engineer . Back-End</p>
